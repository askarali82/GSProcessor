...
//---------------------------------------------------------------------------
__fastcall TAnalysisForm::TAnalysisForm(TComponent* Owner):
    TForm(Owner),
    ...
    FinalSpcChartLeftAxisMinimum(-100)
{
    ...
    ShiftingForm = new TShiftingForm(this);
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::CreateParams(TCreateParams &Params)
{
    try
    {
...
//---------------------------------------------------------------------------
TData TAnalysisForm::GetData() const
{
...
//---------------------------------------------------------------------------
void TAnalysisForm::InitStdSamples(TSettingsForm *Form)
{
...
//---------------------------------------------------------------------------
void TAnalysisForm::SetEnergyRanges(TSettingsForm *Settings)
{
...
//---------------------------------------------------------------------------
void TAnalysisForm::CreateVirtualSpectraFrom3Set(const int __LangID, const double DensityInGramPerLitre)
{
    // Th-232
    LOG(L"Creating Th...");
    bool DensityOK =
...
//---------------------------------------------------------------------------
void TAnalysisForm::CreateVirtualSpectraFrom2Set(
...
//---------------------------------------------------------------------------
void TAnalysisForm::CreateVirtualSpectra()
{
...
//---------------------------------------------------------------------------
void TAnalysisForm::CalculateCountsInStdSamples()
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnParamChange(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::FinalSpcChartMouseDown(TObject *Sender, TMouseButton Button,
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::FinalSpcChartMouseUp(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
    if (Selecting && Button == mbLeft)
    {
        ...
        const int StartCh = Utils::FindChannelByEnergy(StartVal, FinalSpectrum);
        const int EndCh = Utils::FindChannelByEnergy(EndVal, FinalSpectrum);
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnChartMouseMove(TObject *Sender, TShiftState Shift,
          int X, int Y)
{
    ...
    const int Ch = Utils::FindChannelByEnergy(En, Series);
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnChartAfterDraw(TObject *Sender)
{
    TChart *Chart = dynamic_cast<TChart *>(Sender);
    TLineSeries *Series = dynamic_cast<TLineSeries *>(Chart->SeriesList->Items[0]);
    if (Series->Count() <= 0)
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::ParamEditClick(TObject *Sender)
{
    TEdit *ParamEdit = dynamic_cast<TEdit *>(Sender);
    ParamEdit->SelectAll();
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::ShiftingButtonClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnShiftingDataChange(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnShiftingTimerTimer(TObject *Sender)
{
    ShiftingTimer->Enabled = false;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnCh1LeftShiftBtnClick(TObject *Sender)
{
    TEdit *DValEdit1;
    TEdit *Chan1Edit;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnCh1RightShiftBtnClick(TObject *Sender)
{
    TEdit *DValEdit1;
    TEdit *Chan1Edit;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnCh2LeftShiftBtnClick(TObject *Sender)
{
    TEdit *DValEdit2;
    TEdit *Chan2Edit;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnCh2RightShiftBtnClick(TObject *Sender)
{
    TEdit *DValEdit2;
    TEdit *Chan2Edit;
...
//---------------------------------------------------------------------------
int TAnalysisForm::CalcCenterOfPeak(const TSpectrum &Spc, const double Energy) const
{
    try
    {
        if (Spc.IsValid())
...
//---------------------------------------------------------------------------
bool TAnalysisForm::OpenSampleSpectrum(const String &FileName)
{
    TSpectrum Spc;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OpenButtonClick(TObject *Sender)
{
    OpenSpectrumAction->Execute();
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OpenSpectrumActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OpenParametersActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SaveSpectraButtonClick(TObject *Sender)
{
    SaveSpectraAction->Execute();
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SaveSpectraActionExecute(TObject *Sender)
{
    const int __LangID = LangID;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SaveParametersActionExecute(TObject *Sender)
{
    const int __LangID = LangID;
    if (!SampleSpc.IsValid() || SampleSpectrum->Count() == 0)
    {
...
//---------------------------------------------------------------------------
void TAnalysisForm::SaveParametersFile(const String &FileName)
{
    try
    {
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SelectFilesActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::BatchProcessButtonClick(TObject *Sender)
{
    SelectDirectoryAction->Execute();
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SelectDirectoryActionExecute(TObject *Sender)
{
    String FolderName;
    PIDLIST_ABSOLUTE pidl = SHBrowseForFolderW(&BrowseInfo);
    if (pidl != nullptr)
...
//---------------------------------------------------------------------------
void TAnalysisForm::OpenFromBatchResult(
...
//---------------------------------------------------------------------------
void TAnalysisForm::ChangeUILanguage()
{
    const int __LangID = LangID;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::RaCoeffCalcLabelClick(TObject *Sender)
{
    RaSnSe2->Text = RaSnSe1->Text;
    RaSnSe2->SetFocus();
    RaSnSe2->SelectAll();
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::KCoeffCalcLabelClick(TObject *Sender)
{
    KSnSe2->Text = KSnSe1->Text;
    KSnSe2->SetFocus();
    KSnSe2->SelectAll();
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::CsCoeffCalcLabelClick(TObject *Sender)
{
    CsSnSe2->Text = CsSnSe1->Text;
    CsSnSe2->SetFocus();
    CsSnSe2->SelectAll();
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
    if (Key == L',')
    {
        Key = L'.';
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnEditUpButtonClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnEditDownButtonClick(TObject *Sender)
{
    TComponent *C = dynamic_cast<TComponent*>(Sender);
    TEdit *Edit = reinterpret_cast<TEdit*>(C->Tag);
    if (Trim(Edit->Text).IsEmpty())
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SampleChartDblClick(TObject *Sender)
{
    if (!SampleSpc.IsValid() || SampleSpectrum->Count() == 0)
    {
        return;
...
//---------------------------------------------------------------------------
void TAnalysisForm::SetSampleSpectrum(const TSpectrum &ShiftedSpc, const String &Ch1Str, const String &Ch2Str)
{
    try
    {
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::BeActLabelClick(TObject *Sender)
{
    const int __LangID = LangID;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::ChangeFinalSpcScaleActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::ChangeFinalSpcScaleActionUpdate(TObject *Sender)
{
    ChangeFinalSpcScaleAction->Enabled = FinalSpectrum->Count() > 0;
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SubtractBkgActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SubtractBkgActionUpdate(TObject *Sender)
{
    SubtractBkgAction->Enabled = false;//FinalSpectrum->Count() > 0;
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SmoothFInalSpectrumActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::SmoothFInalSpectrumActionUpdate(TObject *Sender)
{
    SmoothFInalSpectrumAction->Enabled = FinalSpectrum->Count() > 0;
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::IncreaseSampleDensityActionExecute(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::DecreaseSampleDensityActionExecute(TObject *Sender)
{
    DensityInGramPerLitre -= 50;
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnSampleDensityActionUpdate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnSpcShiftEditEnter(TObject *Sender)
{
    TEdit *Edit = dynamic_cast<TEdit *>(Sender);
    OnSpcPanelClick(Edit->Parent);
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnChartClick(TObject *Sender)
{
    TChart *Chart = dynamic_cast<TChart *>(Sender);
    OnSpcPanelClick(Chart->Parent);
}
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::FormKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::FormKeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::OnShiftingRepeaterTimer(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::FinalSpcChartClickAxis(TCustomChart *Sender, TChartAxis *Axis,
...
//---------------------------------------------------------------------------
void __fastcall TAnalysisForm::FormClose(TObject *Sender, TCloseAction &Action)
{
    Action = caFree;
